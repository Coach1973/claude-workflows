...
- [開發哲學：站在巨人的肩膀上] 開發新技能前，必須先去 GitHub 或 ClawHub 尋找開源的成功案例，研究其優缺點，在別人的基礎上優化，絕對不從頭造輪子。(2026-04-12)
## 🚀 待辦與未完成專案 (2026-04-12 桌面版 Gemini 盤點)
- [ ] FB 生日祝賀自動化 (需研究滑鼠停留選項邏輯)
- [ ] LINE/通訊軟體控制 (安全穩定的桌面端自動化)
- [ ] 影片重點抓取自動化流程
- [ ] 圖片製作模板化
